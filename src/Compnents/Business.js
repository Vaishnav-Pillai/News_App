...
export class Business extends Component {
    ...
    async componentDidMount(){
        ...
        let url="https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=c83f6c6fa7ee43eeab6af9de6e16c2b4&page=1&pagesize=8";
    ...
    handlePrevClick = async ()=>{
        this.props.setProgress(10);
        let url=`https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=c83f6c6fa7ee43eeab6af9de6e16c2b4&page=${this.state.page - 1}&pagesize=8`;
        this.setState({loading: true});
        let data=await fetch(url);
        let parsedData=await data.json()
